/*
Experiment 2b - CPU Scheduling Algorithms (Shortest Job First)
*/
package sjf;
...
public class SJF {
    ...
    public static void main(String[] args) {
        ...
        for (st = 0; count != pno; st++) {
            ...
            bt[smallest]--; // dec burst time by 1...we decrement step by step i.e 1 by 1 to check if there
                            // is any other process at that particular time having burst time less
        ...
        for (int i = 0; i < pno; i++) {
            System.out.println("\t\t" + pid[i] + "\t\t" + at[i] + "\t\t" + bt1[i] + "\t\t" + tat[i] + "\t\t" + wt[i]
                    + "\t\t" + ct[i] + "\t\t");
        }
    }
}
